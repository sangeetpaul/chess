...
for m,n in tqdm(MN):
    ...
    while radius<=max_radius:
        ...
        N = piece.Leaper((radius,radius),[(m,n)],'white')
    ...
    ax.invert_yaxis()
    ax.set_title(f'({m},{n})-leaper: radius={radius}, step={len(labels)-1}, square={labels[-1]}')
    fig.tight_layout()
    fig.savefig(f'./plots/leapers/leaper_{m}_{n}.png')